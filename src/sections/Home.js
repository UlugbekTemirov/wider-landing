...
import { DemoButton, StartNowButton } from "../components/Buttons";
...
const Home = ({ id }) => {
  ...
  return (
    <div
      id={id}
      className="xl:pt-[96px] md:pt-16 pt-5 bg-[#F9F5FF] md:pb-[50px] pb-10 overflow-hidden relative"
    >
      <Container>
        <div className="md:mb-[48px] mb-10">
          ...
          <p className="text-[#6941C6] leading-[20px] text-center mt-6 md:max-w-[60%] mx-auto font-normal">
            AI-powered simulator to self-practice the IELTS speaking mock exam,
